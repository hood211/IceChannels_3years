# Model selection tables for areal GAMMs from 2015
# JMH Jan 2023
...
## Model Selection tables ---
  ...
  ModelSelTable_AFDM_2015 <- ModelSelTableFun(AFDM_ModSel, "Biomass (g AFDM/m2)", ModelFancyNames)
  ModelSelTable_ER_2015 <- ModelSelTableFun(ER_ModSel, "ER (µM C/m2/h)", ModelFancyNames)
  ModelSelTable_GPP_2015 <- ModelSelTableFun(GPP_ModSel, "GPP (µM C/m2/h)", ModelFancyNames)
  ModelSelTable_NEP_2015 <- ModelSelTableFun(NEP_ModSel, "NEP (µM C/m2/h)", ModelFancyNames)
  ModelSelTable_Nfix_2015 <- ModelSelTableFun(Nfix_ModSel, "N fixation (µM N/m2/h)", ModelFancyNames)
  ModelSelTable_Nup_2015 <- ModelSelTableFun(Nup_ModSel, "NH4 uptake (µM N/m2/h)", ModelFancyNames)
  ModelSelTable_TotAssim_2015 <- ModelSelTableFun(TotAssim_ModSel, "Tot. N Assim (µM N/m2/h)", ModelFancyNames)
  
  # combine
  ModelSelTable_2015 <- rbind(ModelSelTable_AFDM_2015,
                              ModelSelTable_ER_2015,
  ...
  ModelSelTable_2015_2 <- ModelSelTable_2015 %>% 
    ...
    gtsave("04_Tables4MS/ModelSelTable_2015.rtf")
