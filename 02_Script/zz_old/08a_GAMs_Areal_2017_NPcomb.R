...
## Respiration ----
  ...
  # output model
  saveRDS(ER_MostLikely, "03_Model_RDS/08a_Areal_2017_ER_mostlikely_NPcomb.rds")
...
# output model
saveRDS(GPP_MostLikely, "03_Model_RDS/08a_Areal_2017_GPP_mostlikely_NPcomb.rds")
...
# output model
saveRDS(NEP_MostLikely, "03_Model_RDS/08a_Areal_2017_NEP_mostlikely_NPcomb.rds")
...
# output model
saveRDS(Nup_MostLikely, "03_Model_RDS/08a_Areal_2017_Nup_mostlikely_NPcomb.rds")
...
# output model
saveRDS(Nfix_MostLikely, "03_Model_RDS/08a_Areal_2017_Nfix_mostlikely_NPcomb.rds")
...
# output model
saveRDS(Nass_MostLikely, "03_Model_RDS/08a_Areal_2017_Nass_mostlikely_NPcomb.rds")
...
## Biomass ----
  ...
  # output model
  saveRDS(AFDM_MostLikely, "03_Model_RDS/08a_Areal_2017_AFDM_mostlikely_NPcomb.rds")  


# save image ----
# save.image("02b_Script_SavedImages/08a_2017_GAMs_Areal_NPcomb.Rdata")
# load("02b_Script_SavedImages/08a_2017_GAMs_Areal_NPcomb.Rdata")
