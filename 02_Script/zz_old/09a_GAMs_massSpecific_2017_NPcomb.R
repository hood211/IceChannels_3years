...
# although all are 'similar' to the temp only model, which I'm using
ER_MostLikely <- gam(
...
# output model
saveRDS(ER_MostLikely, "03_Model_RDS/09a_MassSpec_2017_ER_mostlikely_NPcomb.rds")
...
# output model
saveRDS(GPP_MostLikely, "03_Model_RDS/09a_MassSpec_2017_GPP_mostlikely_NPcomb.rds")
...
# output model
saveRDS(NEP_MostLikely, "03_Model_RDS/09a_MassSpec_2017_NEP_mostlikely_NPcomp.rds")
